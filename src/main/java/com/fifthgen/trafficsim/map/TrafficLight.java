...
public class TrafficLight {
    public static final double[] DEFAULT_SWITCH_INTERVALS = new double[]{5000, 1000, 5000};

    protected static final double JUNCTION_FREE_TIME = 2000;

    protected double redPhaseLength_;

    protected double yellowPhaseLength_;

    protected double greenPhaseLength_;

    protected int state = 0;

    protected Street[] streets_;

    protected boolean[] streetIsPriority_;

    protected double timer_;

    protected Junction junction_;

    protected boolean switcher = true;

    public TrafficLight(double[] interval, Junction junction) {
        junction_ = junction;
