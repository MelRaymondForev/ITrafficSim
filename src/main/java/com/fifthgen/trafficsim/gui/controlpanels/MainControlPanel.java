...
public final class MainControlPanel extends JPanel implements ChangeListener {
    ...
    private final LevelOfServiceControlPanel levelOfServiceControlPanel = new LevelOfServiceControlPanel();
    ...
    public MainControlPanel() {
        ...
        tabbedPane.addTab(Messages.getString("MainControlPanel.levelOfServiceTab"), levelOfServiceControlPanel);
